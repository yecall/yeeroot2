...
pub fn gen_extrinsic_proof<B>(header: &B::Header, body: &[B::Extrinsic]) -> (H256, ExtrinsicProof)
    where
        B: Block,
        DigestItemFor<B>: yc_sharding::ShardingDigestItem<u16>,
